namespace :litestream do
  ...
  task restore: :environment do
    ...
    Litestream::Commands.restore(options.delete("--database") || options.delete("-database"), async: true, **options)
  end
  ...
  task generations: :environment do
    ...
    Litestream::Commands.generations(options.delete("--database") || options.delete("-database"), async: true, **options)
  end
  ...
  task snapshots: :environment do
    ...
    Litestream::Commands.snapshots(options.delete("--database") || options.delete("-database"), async: true, **options)
  end
  ...
  task verify: :environment do
    ...
    result = Litestream::Commands.verify(options.delete("--database") || options.delete("-database"), async: true, **options)
